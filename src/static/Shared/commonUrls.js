...
import LectureResourceIconSvg from "../../assets/svg/icon/document-text.svg";
import TimetableIconSvg from "../../assets/svg/icon/template.svg";
import UserIconSvg from "../../assets/svg/icon/user.svg";

export const HANGANG_MAIN_IMG = HangangMainSvg;
export const HANGANG_LOGO = HangangLogoSvg;
...
export const TIMETABLE_ICON = TimetableIconSvg;
export const USER_ICON = UserIconSvg;
